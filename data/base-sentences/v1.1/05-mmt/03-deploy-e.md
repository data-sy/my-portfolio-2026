...
| action_2 | Docker Compose로 애플리케이션, DB, Redis 컨테이너 구성. 서버 환경을 코드로 정의하여 어떤 서버에서든 동일한 실행 환경 보장 |
| action_3 | GitHub Actions에서 Docker 이미지 빌드 → Docker Hub 푸시 → EC2에서 pull + 재시작 |
